# Mimir App Audit — Performance checklist
...
on a `mimir/performance` branch, never inline.

This file is the canonical home for rendering/bundle/image/caching checks; the UI audit's
"Performance & Loading Speed" area points back here to avoid duplicate work.


### 1. Eliminate unnecessary component re-renders  ·  **severity: medium**
...
### 2. Memoize expensive computed values  ·  **severity: medium**
...
### 3. Stabilize callbacks passed to children  ·  **severity: medium**
...
### 4. Split bloated global state  ·  **severity: medium**
...
### 5. Virtualize long scrolling lists  ·  **severity: medium**
...
### 6. Debounce text input and search  ·  **severity: medium**
...
### 7. Throttle scroll and resize handlers  ·  **severity: medium**
...
### 8. Batch related state updates  ·  **severity: medium**
...
### 9. Replace scroll listeners with observers  ·  **severity: medium**
...
### 10. Move heavy computation to Web Workers  ·  **severity: medium**
...
### 11. Break up long main-thread tasks  ·  **severity: medium**
...
### 12. Memoize list items and stabilize keys  ·  **severity: medium**
...
### 13. Defer rendering offscreen components  ·  **severity: medium**
...
### 14. Add skeleton loading placeholders  ·  **severity: low**
...
### 15. Apply optimistic UI updates  ·  **severity: low**
...
### 16. Prefetch the next likely route  ·  **severity: low**
...
### 17. Stream server-rendered HTML progressively  ·  **severity: low**
...
### 18. Show instant feedback on interactions  ·  **severity: low**
...
### 19. Lazy-load below-the-fold page sections  ·  **severity: low**
...
### 20. Prioritize above-the-fold content first  ·  **severity: low**
...
### 21. Add route-level loading states  ·  **severity: low**
...
### 22. Preconnect to critical third-party origins  ·  **severity: low**
...
### 23. Reserve space to avoid load shift  ·  **severity: low**
...
### 24. Render a fast static shell first  ·  **severity: low**
...
### 25. Convert images to modern formats  ·  **severity: medium**
...
### 26. Serve responsive image sizes  ·  **severity: medium**
...
### 27. Lazy-load images below the fold  ·  **severity: medium**
...
### 28. Compress and right-size large images  ·  **severity: medium**
...
### 29. Set image dimensions to stop shift  ·  **severity: medium**
...
### 30. Subset and preload web fonts  ·  **severity: medium**
...
### 31. Use swap to avoid invisible text  ·  **severity: medium**
...
### 32. Lazy-load and poster-optimize video  ·  **severity: medium**
...
### 33. Self-host critical third-party assets  ·  **severity: medium**
...
### 34. Inline tiny critical SVGs and icons  ·  **severity: medium**
...
### 35. Serve all static media via CDN  ·  **severity: medium**
...
### 36. Code-split the app by route  ·  **severity: medium**
...
### 37. Remove unused dependencies and dead code  ·  **severity: medium**
...
### 38. Tree-shake and dedupe the bundle  ·  **severity: medium**
...
### 39. Analyze bundle composition for bloat  ·  **severity: medium**
...
### 40. Defer and async non-critical scripts  ·  **severity: medium**
...
### 41. Minify JS, CSS, and HTML  ·  **severity: medium**
...
### 42. Lazy-initialize heavy client libraries  ·  **severity: medium**
...
### 43. Replace heavy libraries with lighter ones  ·  **severity: medium**
...
### 44. Hash filenames for long-term caching  ·  **severity: medium**
...
### 45. Split vendor and app bundles  ·  **severity: medium**
...
### 46. Eliminate render-blocking CSS on load  ·  **severity: medium**
...
### 47. Compress API responses in transit  ·  **severity: medium**
...
### 48. Trim oversized API payloads  ·  **severity: medium**
...
### 49. Parallelize independent async requests  ·  **severity: medium**
...
### 50. Eliminate sequential request waterfalls  ·  **severity: medium**
...
### 51. Deduplicate concurrent identical requests  ·  **severity: medium**
...
### 52. Paginate large API responses  ·  **severity: medium**
...
### 53. Add timeouts and retry with backoff  ·  **severity: medium**
...
### 54. Cache GET responses with validators  ·  **severity: medium**
...
### 55. Use stale-while-revalidate on the client  ·  **severity: medium**
...
### 56. Batch many small requests together  ·  **severity: medium**
...
### 57. Reuse connections with keep-alive  ·  **severity: medium**
...
### 58. Move reads to the edge  ·  **severity: medium**
...
### 59. Add a client-side request cache  ·  **severity: medium**
...
### 60. Add a server cache for hot data  ·  **severity: medium**
...
### 61. Set correct Cache-Control headers  ·  **severity: medium**
...
### 62. Cache expensive computed results  ·  **severity: medium**
...
### 63. Choose sensible cache TTLs  ·  **severity: medium**
...
### 64. Invalidate caches on writes  ·  **severity: medium**
...
### 65. Add an in-memory cache layer  ·  **severity: medium**
...
### 66. Cache rendered pages or fragments  ·  **severity: medium**
...
### 67. Warm caches for hot paths  ·  **severity: medium**
...
### 68. Add a service worker asset cache  ·  **severity: medium**
...
### 69. Index frequently queried columns  ·  **severity: high**
...
### 70. Fix N+1 query patterns  ·  **severity: high**
...
### 71. Select only needed columns  ·  **severity: high**
...
### 72. Add composite indexes for filters  ·  **severity: high**
...
### 73. Switch to cursor-based pagination  ·  **severity: high**
...
### 74. Profile and fix slow queries  ·  **severity: high**
...
### 75. Cache repeated read queries  ·  **severity: high**
...
### 76. Batch inserts and updates  ·  **severity: high**
...
### 77. Add covering indexes for hot reads  ·  **severity: high**
...
### 78. Materialize expensive aggregation queries  ·  **severity: high**
...
### 79. Use database connection pooling  ·  **severity: high**
...
### 80. Avoid loading whole tables into memory  ·  **severity: high**
...
### 81. Denormalize critical read paths  ·  **severity: high**
...
### 82. Route reads to a replica  ·  **severity: high**
...
### 83. Partition or archive huge tables  ·  **severity: high**
...
### 84. Add database query timeouts  ·  **severity: high**
...
### 85. Offload slow work to background jobs  ·  **severity: high**
...
### 87. Replace blocking I/O with async  ·  **severity: high**
...
### 88. Reduce serverless cold starts  ·  **severity: high**
...
### 89. Profile and optimize hot paths  ·  **severity: high**
...
### 90. Pool and reuse expensive resources  ·  **severity: high**
...
### 91. Add a circuit breaker for slow deps  ·  **severity: high**
...
### 92. Rate-limit to protect under load  ·  **severity: high**
...
### 93. Compress and cache server templates  ·  **severity: high**
...
### 94. Gracefully degrade non-critical features  ·  **severity: high**
...
### 95. Add real-user performance monitoring  ·  **severity: low**
...
### 96. Run Lighthouse and fix top issues  ·  **severity: low**
...
### 97. Reduce Largest Contentful Paint  ·  **severity: low**
...
### 98. Reduce Cumulative Layout Shift  ·  **severity: low**
...
### 99. Improve Interaction to Next Paint  ·  **severity: low**
...
### 100. Set a performance budget in CI  ·  **severity: low**
