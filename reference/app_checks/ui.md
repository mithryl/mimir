# Mimir App Audit — UI / UX checklist

Loaded when the user invokes **"summon mimir to audit the UI"** / `/mimir ui`.

100 UI/UX flaws an LLM builder commonly ships past: design-system consistency, layout &
responsiveness, typography, accessibility, motion, forms, feedback/system states,
...
detail, and the specific remediation. Mark genuinely inapplicable checks N/A with a
one-line reason. Fixes happen only after the user opts in (see SKILL.md "App audit mode")
on a `mimir/ui` branch, never inline.

The "Performance & Loading Speed" area here defers to `performance.md` to avoid
double-reporting; see the dedup notes inline.


### 1. Establish a Design Token System  ·  **severity: low**
...
### 2. Build a Semantic Color System  ·  **severity: low**
...
### 3. Define a Consistent Spacing Scale  ·  **severity: low**
...
### 4. Create an Elevation Shadow System  ·  **severity: low**
...
### 5. Standardize the Border Radius Scale  ·  **severity: low**
...
### 6. Strengthen Overall Visual Hierarchy  ·  **severity: low**
...
### 7. Polish All Button Interaction States  ·  **severity: low**
...
### 8. Design Helpful Empty States  ·  **severity: low**
...
### 9. Unify the App's Iconography  ·  **severity: low**
...
### 10. Run a Full Consistency Audit  ·  **severity: low**
...
### 11. Audit Mobile and Tablet Breakpoints  ·  **severity: medium**
...
### 12. Eliminate Horizontal Scroll on Mobile  ·  **severity: medium**
...
### 13. Build a Flexible Responsive Grid  ·  **severity: medium**
...
### 14. Enlarge Mobile Touch Targets  ·  **severity: medium**
...
### 15. Eliminate Cumulative Layout Shift  ·  **severity: medium**
...
> **Dedup note:** Overlaps `performance.md` (CLS / reserve-space checks). Performance is the canonical home; if you ran the performance audit this session, skip unless it left this unresolved.

### 16. Respect Mobile Safe Area Insets  ·  **severity: medium**
...
### 17. Build a Smart Sticky Header  ·  **severity: medium**
...
### 18. Balance Content Density and Whitespace  ·  **severity: medium**
...
### 19. Use Container Queries for Components  ·  **severity: medium**
...
### 20. Untangle Z-Index Stacking Issues  ·  **severity: medium**
...
### 21. Establish a Modular Type Scale  ·  **severity: low**
...
### 22. Add Fluid Responsive Typography  ·  **severity: low**
...
### 23. Optimize Reading Line Length  ·  **severity: low**
...
### 24. Optimize Web Font Loading  ·  **severity: low**
...
### 25. Tune Text Color and Contrast  ·  **severity: low**
...
### 26. Fix Semantic Heading Structure  ·  **severity: low**
...
### 27. Handle Text Overflow Gracefully  ·  **severity: low**
...
### 28. Format Numbers, Dates, and Currency  ·  **severity: low**
...
### 29. Add Refined Typographic Details  ·  **severity: low**
...
### 30. Standardize Text Casing and Labels  ·  **severity: low**
...
### 31. Run a Full Performance Audit  ·  **severity: low**
...
> **Dedup note:** This entire area overlaps the performance audit. `performance.md` is the canonical home for rendering, bundle, image, font, and caching checks. If you ran `summon mimir to audit performance` this session, skip this item unless that audit surfaced it as unresolved.

### 32. Shrink the JavaScript Bundle  ·  **severity: low**
...
### 33. Add Route-Based Code Splitting  ·  **severity: low**
...
### 34. Optimize and Modernize All Images  ·  **severity: low**
...
### 35. Implement Content-Aware Loading Skeletons  ·  **severity: low**
...
### 36. Virtualize Long Scrolling Lists  ·  **severity: low**
...
### 37. Eliminate Unnecessary Component Re-renders  ·  **severity: low**
...
### 38. Cache and Dedupe Data Fetching  ·  **severity: low**
...
### 39. Add Optimistic UI Updates  ·  **severity: low**
...
### 40. Prefetch Data on User Intent  ·  **severity: low**
...
### 41. Debounce and Throttle Costly Handlers  ·  **severity: low**
...
### 42. Optimize the Critical Rendering Path  ·  **severity: low**
...
### 43. Audit Third-Party Script Performance  ·  **severity: low**
...
### 44. Load Critical Content First  ·  **severity: low**
...
### 45. Run a Full Accessibility Audit  ·  **severity: high**
...
### 46. Make Everything Keyboard Navigable  ·  **severity: high**
...
### 47. Add Clear Visible Focus Indicators  ·  **severity: high**
...
### 48. Make Forms Fully Accessible  ·  **severity: high**
...
### 49. Use Proper Semantic HTML  ·  **severity: high**
...
### 50. Add Meaningful Image Alt Text  ·  **severity: high**
...
### 51. Respect Reduced Motion Preferences  ·  **severity: high**
...
### 52. Announce Dynamic Changes to Screen Readers  ·  **severity: high**
...
### 53. Build Fully Accessible Modals  ·  **severity: high**
...
### 54. Don't Rely on Color Alone  ·  **severity: high**
...
### 55. Add a Skip-To-Content Link  ·  **severity: high**
...
### 56. Fix Page Titles and Language  ·  **severity: high**
...
### 57. Add Small Purposeful Micro-Interactions  ·  **severity: low**
...
### 58. Standardize Animation Timing and Easing  ·  **severity: low**
...
### 59. Implement Smooth Page Transitions  ·  **severity: low**
...
### 60. Animate Value and State Changes  ·  **severity: low**
...
### 61. Refine Hover and Focus Feedback  ·  **severity: low**
...
### 62. Add Tasteful Scroll-Triggered Animations  ·  **severity: low**
...
### 63. Smooth the Loading-To-Content Transition  ·  **severity: low**
...
### 64. Improve Drag-And-Drop Interface Affordances  ·  **severity: low**
...
### 65. Add Mobile Gesture Support  ·  **severity: low**
...
### 66. Add Subtle Success Moments  ·  **severity: low**
...
### 67. Add Real-Time Inline Validation  ·  **severity: medium**
...
### 68. Write Clear Helpful Error Messages  ·  **severity: medium**
...
### 69. Polish Input Field Design and States  ·  **severity: medium**
...
### 70. Add Smart Input Masking and Formatting  ·  **severity: medium**
...
### 71. Add Form Autosave and Recovery  ·  **severity: medium**
...
### 72. Improve Multi-Step Form Experience  ·  **severity: medium**
...
### 73. Upgrade Select and Dropdown Inputs  ·  **severity: medium**
...
### 74. Improve Password Field UX  ·  **severity: medium**
...
### 75. Add Input Hints and Affordances  ·  **severity: medium**
...
### 76. Clarify Form Submission Feedback  ·  **severity: medium**
...
### 77. Build a Toast Notification System  ·  **severity: medium**
...
### 78. Handle Loading, Empty, Error, Success States  ·  **severity: medium**
...
### 79. Add Graceful Error Boundaries  ·  **severity: medium**
...
### 80. Confirm Destructive and Irreversible Actions  ·  **severity: medium**
...
### 81. Add Undo for Reversible Actions  ·  **severity: medium**
...
### 82. Handle Offline and Network Errors  ·  **severity: medium**
...
### 83. Show Progress for Long Operations  ·  **severity: medium**
...
### 84. Improve Perceived Performance Everywhere  ·  **severity: medium**
...
### 85. Add Contextual Help and Tooltips  ·  **severity: medium**
...
### 86. Standardize Status and State Indicators  ·  **severity: medium**
...
### 87. Clarify Primary Navigation Structure  ·  **severity: medium**
...
### 88. Add a Command Palette  ·  **severity: medium**
...
### 89. Show Clear Active Location Indicators  ·  **severity: medium**
...
### 90. Add Breadcrumbs for Deep Navigation  ·  **severity: medium**
...
### 91. Improve In-App Search Experience  ·  **severity: medium**
...
### 92. Fix Scroll Position and Back Behavior  ·  **severity: medium**
...
### 93. Add Useful Keyboard Shortcuts  ·  **severity: medium**
...
### 94. Reduce Friction in Key Flows  ·  **severity: medium**
...
### 95. Make Data Tables Genuinely Usable  ·  **severity: medium**
...
### 96. Add Powerful Filtering and Sorting  ·  **severity: medium**
...
### 97. Add Pagination or Infinite Scroll  ·  **severity: medium**
...
### 98. Polish Charts and Data Visualization  ·  **severity: medium**
...
### 99. Add Bulk Selection and Actions  ·  **severity: medium**
...
### 100. Add Data Export and Sharing  ·  **severity: medium**
